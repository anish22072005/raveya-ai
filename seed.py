"""
Seed demo data into the database for development and testing.
Run standalone:  python seed.py
Or called automatically at startup in development mode.
"""
import asyncio
...
DEMO_ORDERS = [
    {
        ...
        "tracking_number": "BLUEDRT1234567",
    ...
    },
    {
        ...
        "tracking_number": "BLUEDRT9876543",
...
async def seed_demo_data():
    """Insert demo orders if they don't already exist."""
    async with AsyncSessionLocal() as session:
        ...
        print(f"Seeded {len(DEMO_ORDERS)} demo orders.")
